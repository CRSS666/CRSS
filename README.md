...
<img width="300px" alt="Banner of [NATION-NAME]" src="./Nations/[NATION-NAME]/Banner.svg">

- President: WorldWidePixel
- Flag: <img height="12px" alt="Flag of [NATION-NAME]" style="vertical-align: middle;" src="./Nations/[NATION-NAME]/Flag.svg"> [(Link to image)](./Nations/Republic%20of%20Panorama/Flag.svg)
- Website: https://[nation-3ltr-code].crssi.cc
...
- Type: Audiovisual Media Producer
  - Studios:
    ...
    - Oak Studios (   , CRSS 3)
    - Golden Studios (The Strudel, Craftocracy)
